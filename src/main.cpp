...
int main() {
  ...
  unsigned int vertex_shader =
      init_shader(GL_VERTEX_SHADER, "../shaders/vs.glsl");
  unsigned int fragment_shader =
      init_shader(GL_FRAGMENT_SHADER, "../shaders/fs.glsl");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    std::cout << "Vertex Color Location" << vertex_color_location << std::endl;
